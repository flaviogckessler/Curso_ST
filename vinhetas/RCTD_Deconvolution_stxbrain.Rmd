...
5.  Copie o caminho mostrado entre aspas e cole no lugar de `COLE_AQUI_O_DIRETORIO_DA_VINHETA` no bloco seguinte. No Windows, prefira barras `/`, como no exemplo, ou duplique cada barra invertida: `\\`.
...
diretorio_vinheta <- "COLE_AQUI_O_DIRETORIO_DA_VINHETA"
